---
title: 'aws\_bucket\_creator'
---

Features
========

aws\_bucket\_creator creates a bucket, sets the policy, tags and lifecycle policy
...
aws\_bucket\_creator is on PyPI so all you need is:
